class EnvironmentsController < ApplicationController
  ...
  private
    ...
    def environment_params
      params.require(:environment).permit(:name, :aws_account_id, :primary_vpc_id, :dr_vpc_id, :dr_enabled, :checkpoint_freqency_id, :dr_lead_time)
